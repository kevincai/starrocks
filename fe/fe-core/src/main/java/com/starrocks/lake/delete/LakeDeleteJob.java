...
public class LakeDeleteJob extends DeleteJob {
    ...
    static private String getTableColumnId(Table table, String columnName) throws DmlException {
        Column column = table.getColumn(columnName);
        if (column == null) {
            throw new DmlException(String.format("can not find column by name: %s", columnName));
        }
